...
<div class="d-flex justify-content-between align-items-center">
<div>
<h3 class="mb-0" id="totalRetraits">--- $</h3>
...
<textarea class="form-control" id="bankTransferNotes" placeholder="Autres informations que vous souhaitez ajouterا" rows="3"></textarea>
</div>
...
<input class="form-control" name="cardExpiry" id="cardExpiry" placeholder="MM/YY" required="" type="text"/>
</div>
<div class="col-md-6 mb-3">
<label class="form-label" for="cardCVV">Code de sécurité (CVV)</label>
<input class="form-control" name="cardCVV" id="cardCVV" placeholder="XXX" required="" type="text"/>
</div>
</div>
...
<button class="btn btn-outline-secondary" title="نسخ Adresse" type="button">
...
<li class="list-group-item d-flex justify-content-between align-items-center">Montant minimum de dépôt <span class="fw-bold">100 $</span>
</li>
<li class="list-group-item d-flex justify-content-between align-items-center">Montant maximum de dépôt <span class="fw-bold">10,000 $</span>
</li>
...
<div class="mb-3 form-check">
<input checked="" class="form-check-input" id="saveBankInfo" type="checkbox"/>
...
<div class="mb-3 form-check">
<input class="form-check-input" id="savePaypalInfo" type="checkbox"/>
...
<li class="list-group-item d-flex justify-content-between align-items-center"> Montant maximal de retrait <span class="fw-bold">5,000 $</span>
</li>
...
<input class="form-control" id="defaultAccountName" placeholder="Entrez le Nom du titulaire du compte" type="text" value=""/>
</div>
<div class="mb-3">
<label class="form-label" for="defaultAccountNumber">Numéro de compte</label>
<input class="form-control" id="defaultAccountNumber" placeholder="Entrez le Numéro de compte" type="text" value=""/>
</div>
<div class="mb-3">
<label class="form-label" for="defaultIban">IBAN</label>
<input class="form-control" id="defaultIban" placeholder="Entrez le IBAN" type="text" value=""/>
</div>
<div class="mb-3">
<label class="form-label" for="defaultSwiftCode">Code SWIFT/BIC</label>
<input class="form-control" id="defaultSwiftCode" placeholder="Entrez le Code SWIFT/BIC" type="text" value=""/>
</div>
<button class="btn btn-primary" type="submit">
...
<button aria-label="إغلاق" class="btn-close" data-bs-dismiss="modal" type="button"></button>
</div>
...
<!-- Modal: تغيير Image Profil الشخصي -->
...
<!-- Modal: إضافة Portefeuille جديدة -->
...
<button aria-label="إclose" class="btn-close" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
