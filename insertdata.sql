...
INSERT INTO tradingHistory (user_id, operationNumber, temps, paireDevises, type, statutTypeClass, montant, prix, statut, statutClass, profitPerte, profitClass) VALUES (1, 'T1', '2025/06/09 14:30', 'BTC/USD', 'Acheter', 'bg-success', 1000, 500, 'complet', 'bg-success', 175.50, 'text-success');
INSERT INTO tradingHistory (user_id, operationNumber, temps, paireDevises, type, statutTypeClass, montant, prix, statut, statutClass, profitPerte, profitClass) VALUES (1, 'T2', '2025/06/09 13:15', 'ETH/USD', 'Vendre', 'bg-success', 500, 2850, 'complet', 'bg-success', -25.00, 'text-danger');
INSERT INTO tradingHistory (user_id, operationNumber, temps, paireDevises, type, statutTypeClass, montant, prix, statut, statutClass, profitPerte, profitClass) VALUES (1, 'T3', '2025/06/09 12:00', 'ADA/USD', 'Acheter', 'bg-danger', 300, 0.45, 'En cours', 'bg-warning', NULL, '');
